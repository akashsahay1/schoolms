      ...
      if (fs.statSync(filePath).isDirectory()) {
        ...
        plugins.push(
          new HtmlWebpackPlugin({
            ...
            inject: true,
            minify: false, // Disable HTML minification for readable output
          })
        );
      }
    });
...
module.exports = {
    ...
    rules: [
      ...
      },
      {
        ...
        use: {
          loader: "pug-loader",
          options: {
            pretty: true, // Output nicely formatted HTML
          },
        },
      },
      {
  ...
  watch: false, // Set to true for development, false for one-time build
};
