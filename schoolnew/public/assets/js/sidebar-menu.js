(function ($) {
  ...
  // active link
  var activeLink = jQuery(".simplebar-wrapper .simplebar-content-wrapper a.active");
  if (activeLink.length && jQuery(".simplebar-wrapper .simplebar-content-wrapper").length && jQuery("#pageWrapper").hasClass("compact-wrapper")) {
    jQuery(".simplebar-wrapper .simplebar-content-wrapper").animate(
      {
