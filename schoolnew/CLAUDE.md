...
-   Staff management should come under Users (not as a separate menu item)
-   Users menu should contain: All Users, Add User, All Staff, Add Staff

### Page Creation Order
Create pages in this order for proper demo flow:
1. Academic Year setup
2. Classes (depends on Academic Year)
3. Sections (depends on Classes)
4. Subjects
5. Students (depends on Classes & Sections)
6. Staff/Users
7. Other modules (Attendance, Fees, etc.)

## Dynamic Data Population

-   All select fields must be populated dynamically from the database
-   Classes and Sections in Add Student page load from the Classes and Sections tables
-   When selecting a Class, Sections should filter dynamically via AJAX
