...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                    <form action="{{ route('admin.academic-years.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">If checked, this will become the active academic year and deactivate the current one.</small>
                                </div>
                            </div>
                        </div>
