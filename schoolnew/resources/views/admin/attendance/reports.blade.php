...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('admin.attendance.reports') }}" class="row g-3 align-items-end" id="report-form">
                    <div class="col-md-2">
        ...
        @if($reportData->count() > 0)
            <div class="card mt-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5>
                        Attendance Report - {{ $selectedClass->name }}{{ $selectedSection ? ' - Section ' . $selectedSection->name : '' }}
                    </h5>
                    <div>
        ...
        @elseif(request('class_id') && request('from_date') && request('to_date'))
            <div class="card mt-3">
