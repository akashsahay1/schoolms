...
@section('page-title', 'Transport - Add Vehicle')
				...
				<form action="{{ route('admin.transport.vehicles.store') }}" method="POST">
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<input type="text" class="form-control @error('vehicle_no') is-invalid @enderror" id="vehicle_no" name="vehicle_no" value="{{ old('vehicle_no') }}" required>
							@error('vehicle_no')
					...
					<div class="row">
						...
						<div class="col-md-4 mb-3">
							...
							<input type="number" class="form-control @error('year_made') is-invalid @enderror" id="year_made" name="year_made" value="{{ old('year_made') }}" min="1900" max="{{ date('Y') }}">
							@error('year_made')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<input type="text" class="form-control @error('chasis_no') is-invalid @enderror" id="chasis_no" name="chasis_no" value="{{ old('chasis_no') }}">
							@error('chasis_no')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
						...
						<div class="col-md-6 mb-3">
							...
							<input type="number" class="form-control @error('max_seating_capacity') is-invalid @enderror" id="max_seating_capacity" name="max_seating_capacity" value="{{ old('max_seating_capacity') }}" min="1" required>
					...
					<div class="row">
						...
						<div class="col-md-6 mb-3">
							...
							<input type="text" class="form-control @error('driver_contact') is-invalid @enderror" id="driver_contact" name="driver_contact" value="{{ old('driver_contact') }}">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control @error('driver_license') is-invalid @enderror" id="driver_license" name="driver_license" value="{{ old('driver_license') }}">
					...
					<div class="d-flex justify-content-end gap-2">
						...
						<button type="submit" class="btn btn-primary">
							<i data-feather="save" class="me-1"></i> Add Vehicle
						</button>
					</div>
				</form>
			</div>
