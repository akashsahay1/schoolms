				...
				<div class="card-body">
					<div class="row g-3">
						...
						<div class="col-md-4" data-field-wrapper="nationality">
							...
							<input type="text" class="form-control @error('nationality') is-invalid @enderror" id="nationality" name="nationality" value="{{ old('nationality', $staff->nationality) }}" {{ $isRequired('nationality') ? 'required' : '' }}>
							@error('nationality')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
				...
				<div class="card-body">
					<div class="row g-3">
						...
						<div class="col-12" data-field-wrapper="permanent_address">
							...
							<textarea class="form-control @error('permanent_address') is-invalid @enderror" id="permanent_address" name="permanent_address" rows="2" {{ $isRequired('permanent_address') ? 'required' : '' }}>{{ old('permanent_address', $staff->permanent_address) }}</textarea>
				...
				<div class="card-body">
					<div class="row g-3">
						...
						<div class="col-md-6" data-field-wrapper="aadhaar_number">
							...
							<input type="text" class="form-control @error('aadhaar_number') is-invalid @enderror" id="aadhaar_number" name="aadhaar_number" value="{{ old('aadhaar_number', $staff->aadhaar_number) }}" placeholder="Enter 12-digit Aadhaar number" maxlength="12" {{ $isRequired('aadhaar_number') ? 'required' : '' }}>
						...
						<div class="col-md-6" data-field-wrapper="pan_number">
							...
							<input type="text" class="form-control @error('pan_number') is-invalid @enderror" id="pan_number" name="pan_number" value="{{ old('pan_number', $staff->pan_number) }}" placeholder="Enter PAN number" maxlength="10" style="text-transform: uppercase;" {{ $isRequired('pan_number') ? 'required' : '' }}>
							@error('pan_number')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
						...
						<div class="col-md-6" data-field-wrapper="aadhaar_front">
							<label for="aadhaar_front" class="form-label">Aadhaar Card Front @if($isRequired('aadhaar_front') && !$staff->aadhaar_front)<span class="text-danger">*</span>@endif</label>
							<input type="file" class="form-control @error('aadhaar_front') is-invalid @enderror" id="aadhaar_front" name="aadhaar_front" accept="image/*,.pdf" {{ $isRequired('aadhaar_front') && !$staff->aadhaar_front ? 'required' : '' }}>
							@error('aadhaar_front')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						...
						<div class="col-md-6" data-field-wrapper="aadhaar_back">
							<label for="aadhaar_back" class="form-label">Aadhaar Card Back @if($isRequired('aadhaar_back') && !$staff->aadhaar_back)<span class="text-danger">*</span>@endif</label>
							<input type="file" class="form-control @error('aadhaar_back') is-invalid @enderror" id="aadhaar_back" name="aadhaar_back" accept="image/*,.pdf" {{ $isRequired('aadhaar_back') && !$staff->aadhaar_back ? 'required' : '' }}>
							@error('aadhaar_back')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
				...
				<div class="card-body">
					<div class="row g-3">
						...
						<div class="col-12" data-field-wrapper="qualification">
							...
							<textarea class="form-control @error('qualification') is-invalid @enderror" id="qualification" name="qualification" rows="2" {{ $isRequired('qualification') ? 'required' : '' }}>{{ old('qualification', $staff->qualification) }}</textarea>
							@error('qualification')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
						...
						<div class="col-12" data-field-wrapper="experience">
							...
							<textarea class="form-control @error('experience') is-invalid @enderror" id="experience" name="experience" rows="2" {{ $isRequired('experience') ? 'required' : '' }}>{{ old('experience', $staff->experience) }}</textarea>
							@error('experience')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
