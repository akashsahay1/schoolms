...
@php
	$fs = $fieldSettings ?? [];
	$alwaysRequired = ['first_name', 'gender', 'date_of_birth', 'email', 'phone', 'designation_id', 'joining_date', 'contract_type'];
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="row g-3">
						...
						@endif
						@include('admin.custom-fields._section-fields', ['sectionKey' => 'job_details', 'customFieldValues' => []])
					</div>
				</div>
			</div>
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="row g-3">
						...
						@endif
						@include('admin.custom-fields._section-fields', ['sectionKey' => 'documents', 'customFieldValues' => []])
					</div>
				</div>
			</div>
			@endif
