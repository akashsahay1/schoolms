...
@section('page-title', 'Website - Add Facility')
                ...
                <form action="{{ route('admin.website.facilities.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="icon" class="form-control" value="{{ old('icon') }}" placeholder="e.g., book, monitor, users">
                            <small class="text-muted">See <a href="https://feathericons.com" target="_blank">feathericons.com</a> for icon names</small>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i data-feather="save" class="me-1"></i> Save Facility
                        </button>
