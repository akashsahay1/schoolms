                                ...
                                <div class="single-report-admit">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="report-admit-img profile_100" style="background-image: url({{ file_exists(@$studentDetails->student_photo) ? asset($studentDetails->student_photo) : asset('uploads/staff/demo/staff.jpg') }})"></div>
