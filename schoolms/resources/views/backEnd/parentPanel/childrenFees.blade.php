                ...
                <div class="col-lg-4 no-gutters">
                    <div class="d-flex justify-content-between">
                        <div class="main-title">
                            <h3 class="mb-30">@lang('fees.fees_info')</h3>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        @foreach($fees_assigneds as $fees_assigned)
                                                    ...
                                                    @if($already_add == "" && $balance_amount !=0)
                                                        @if(@$data['bank_info']->active_status == 1 || @$data['cheque_info']->active_status == 1)
                                                            ...
                                                            <a class="dropdown-item modalLink"
                                                               ...
                                                               href="{{route('fees-generate-modal-child', [$fees_assigned->fees_amount, $fees_assigned->student_id, $fees_assigned->feesGroupMaster->fees_type_id,$fees_assigned->id])}}"> @lang('fees.add_bank_payment') </a>
                                                        ...
                                                        @if($balance_amount !=0)
                                                            ...
                                                            @if ($already_add!="")
                                                                <a class="dropdown-item modalLink"
                                                                   data-modal-size="modal-lg"
                                                                   title="{{$fees_assigned->feesGroupMaster->feesGroups->name.': '. $fees_assigned->feesGroupMaster->feesTypes->name}}"
                                                                   href="{{route('fees-generate-modal-child-view', [$fees_assigned->student_id,$fees_assigned->feesGroupMaster->fees_type_id,$fees_assigned->id])}}">@lang('common.view_bank_payment') </a>
                                                                ...
                                                                @if(@$already_add->approve_status == 0)
                                                                    <a onclick="deleteId({{@$already_add->id}});"
                                                                       ...
                                                                       data-id="{{@$already_add->id}}">@lang('common.delete_bank_payment')</a>
                            ...
                            @foreach($payments as $payment)
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td class="text-right"><img src="{{asset('backEnd/img/table-arrow.png')}}">
                                    </td>
                                    <td>
                                        @php
