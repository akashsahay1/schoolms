                                        ...
                                        <div class="">
                                            ...
                                            <div class="row mb-30">
                                               <div class="col-md-12">
                                                ...
                                                {
                                                    @$paymeny_gateway = ['gateway_name','gateway_client_id','gateway_secret_key','gateway_publisher_key'];

                                                }
                                                else if(@$row->gateway_name=="PayU")
                                                {
                                                    @$paymeny_gateway = ['gateway_name','gateway_client_id','gateway_secret_key'];
                                                ...
                                                { 
                                                    ...
                                                    if(@$row->gateway_name=="Stripe" || @$row->gateway_name=="Paystack" || @$row->gateway_name=="RazorPay" || @$row->gateway_name=="Xendit" || @$row->gateway_name=="Raudhahpay" || @$row->gateway_name=="PayPal" || @$row->gateway_name=="Khalti" || @$row->gateway_name=="PhonePe" || @$row->gateway_name=="PayU" ){
                                                    $count=0;
