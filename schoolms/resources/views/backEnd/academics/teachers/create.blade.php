...
<section class="admin-visitor-area up_admin_visitor">
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    {{ Form::open(['class' => 'form-horizontal', 'route' => 'academic.teachers.store', 'method' => 'POST', 'files' => true]) }}
                        ...
                        <div class="col-lg-4">
                            <div class="input-effect">
                                <input class="primary-input form-control" type="text" name="staff_no"
                                    value="{{ old('staff_no', $max_staff_no + 1) }}">
                    ...
                    <div class="row mt-25">
                        <div class="col-lg-6">
                            <div class="input-effect">
                                <textarea class="primary-input form-control" name="current_address" rows="3">{{ old('current_address') }}</textarea>
                        ...
                        <div class="col-lg-6 mt-30-md">
                            <div class="input-effect">
                                <textarea class="primary-input form-control" name="permanent_address" rows="3">{{ old('permanent_address') }}</textarea>
                    ...
                    <div class="row mt-25">
                        <div class="col-lg-6">
                            <div class="input-effect">
                                ...
                                <small class="text-muted">@lang('common.max_file_size'): 2MB, @lang('common.allowed_types'): jpg, png</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12">
                            <div class="main-title">
                                <h4 class="stu-sub-head">@lang('common.login_credentials')</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-25">
                        <div class="col-lg-6">
                            <div class="input-effect">
                                ...
                                <label>@lang('common.password') (@lang('common.default'): 123456)</label>
                                <span class="focus-border"></span>
                            </div>
                        </div>
                    </div>
