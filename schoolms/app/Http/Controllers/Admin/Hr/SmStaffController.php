        ...
        try {
            ...
            if ($r->hasFile('logo_pic')) {
                ...
                if (!file_exists($pathImage)) {
                    ...
                    $images->save(public_path('uploads/staff/') . $name);
        ...
        try {
            if ($request->file('staff_upload_document') != "" && $request->title != "") {
                ...
                if ($request->file('staff_upload_document') != "") {
                    ...
                    $file->move(public_path('uploads/staff/document/'), $document_photo);
        ...
        try {
            if ($request->title != "") {
                ...
                if ($request->file('document_file_4') != "") {
                    ...
                    $file->move(public_path('uploads/staff/timeline/'), $document_photo);
