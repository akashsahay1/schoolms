    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('logo') != "") {
                ...
                $file->move(public_path('uploads/studentIdCard/'), $fileNameLogo);
            ...
            if ($request->file('signature') != "") {
                ...
                $file->move(public_path('uploads/studentIdCard/'), $fileNameSignature);
            ...
            if ($request->file('background_img') != "") {
                ...
                $file->move(public_path('uploads/studentIdCard/'), $fileNameBackground);
            ...
            if ($request->file('profile_image') != "") {
                ...
                $file->move(public_path('uploads/studentIdCard/'), $fileNameProfileImage);
