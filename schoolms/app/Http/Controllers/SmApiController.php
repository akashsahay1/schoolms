...
class SmApiController extends Controller
{
    ...
    public function UpdateStaffApi(Request $request)
    {
        ...
        if (!empty($request->field_name)) {
            ...
            if ($request_string == "email") {
                ...
                $images->save(public_path('uploads/staff/') . $staff_photos);
    ...
    public function UpdateStudentApi(Request $request)
    {
        ...
        if (!empty($request->field_name)) {
            ...
            if ($request_string == "first_name") {
                ...
                $images->save(public_path('uploads/student/') . $student_photos);
    ...
    public function visitor_store(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('file') != "") {
                ...
                $file->move(public_path('uploads/visitor/'), $fileName);
    ...
    public function visitor_update(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('file') != "") {
                ...
                if ($visitor->file != "") {
                    $path = public_path('uploads/visitor/' . $visitor->file);
                    if (file_exists($path)) {
                        unlink($path);
                    }
                }
    ...
    public function complaintStore(Request $request)
    {
        ...
        if ($request->file('file') != "") {
            $file = $request->file('file');
            $fileName = md5($file->getClientOriginalName() . time()) . "." . $file->getClientOriginalExtension();
            $file->move(public_path('uploads/complaint/'), $fileName);
    ...
    public function postal_receive_store(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('file') != "") {
                $file = $request->file('file');
                $fileName = md5($file->getClientOriginalName() . time()) . "." . $file->getClientOriginalExtension();
                $file->move(public_path('uploads/postal/'), $fileName);
    ...
    public function saveUploadContent(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('content_file') != "") {
                $file = $request->file('content_file');
                $fileName = md5($file->getClientOriginalName() . time()) . "." . $file->getClientOriginalExtension();
                $file->move(public_path('uploads/upload_contents/'), $fileName);
    ...
    public function income_store(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('file') != "") {
                $file = $request->file('file');
                $fileName = md5($file->getClientOriginalName() . time()) . "." . $file->getClientOriginalExtension();
                $file->move(public_path('uploads/add_income/'), $fileName);
    ...
    public function Approve_Leave_store(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('attach_file') != "") {
                ...
                $fileName = md5($file->getClientOriginalName() . time()) . "." . $file->getClientOriginalExtension();
                $file->move(public_path('uploads/leave_request/'), $fileName);
    ...
    public function updateSchoolLogo(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('main_school_logo') != "") {
                ...
                $file->move(public_path('uploads/settings/'), $main_school_logo);
                ...
                $file->move(public_path('uploads/settings/'), $main_school_favicon);
     ...
     *        "description": "Hello",
     *        "upload_file": "uploads/upload_contents/5b5ec23c13ae51891c941d0d00b5d011.jpg"
     *    }
     *    ]
     *},
    ...
    public function childBankSlipStore(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('slip') != "") {
                ...
                $file->move(public_path('uploads/bankSlip/'), $fileName);
