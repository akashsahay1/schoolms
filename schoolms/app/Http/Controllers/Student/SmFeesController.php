...
// use Unicodeveloper\Paystack\Paystack; // Removed - package not compatible with Laravel 12
...
class SmFeesController extends Controller
{
    ...
    public function __construct()
    {
        $this->middleware('PM');
        // User::checkAuth();
        // $this->paystack = new Paystack(); // Removed - use PaystackPayment gateway instead
    }
    ...
    public function redirectToGateway(Request $request)
    {
        ...
        try {
            ...
            // Use HTTP client directly instead of Paystack package
            $response = Http::withHeaders([
                'Authorization' => 'Bearer ' . $paystack_info->gateway_secret_key,
