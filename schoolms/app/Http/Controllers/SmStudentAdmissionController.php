...
class SmStudentAdmissionController extends Controller
{
    ...
    public function studentStore(Request $request)
    {
        ...
        if ($request->file('document_file_1') != "") {
            ...
            $file->move(public_path('uploads/student/document/'), $document_file_1);
        ...
        if ($request->file('document_file_2') != "") {
            ...
            $file->move(public_path('uploads/student/document/'), $document_file_2);
        ...
        if ($request->file('document_file_3') != "") {
            ...
            $file->move(public_path('uploads/student/document/'), $document_file_3);
        ...
        if ($request->file('document_file_4') != "") {
            ...
            $file->move(public_path('uploads/student/document/'), $document_file_4);
        ...
        try {
            ...
            $user_stu->access_status = 0; // Students cannot login (minors) - parents login instead
            $user_stu->save();
            $user_stu->toArray();
                            ...
                            foreach ($dataImage as $label=> $field)
                            {
                                if (is_object($field)) {
                                    ...
                                    if ($field != "") {
                                        ...
                                        $file->move(public_path('uploads/customFields/'), $key);
        ...
        try {
            ...
            if ($r->hasFile('logo_pic')) {
                ...
                if (!file_exists($pathImage)) {
                    ...
                    $images->save(public_path('uploads/student/') . $name);
        ...
        try {
            if ($request->file('photo') != "" && $request->title != "") {
                ...
                if ($request->file('photo') != "") {
                    ...
                    $file->move(public_path('uploads/student/document/'), $document_photo);
        ...
        try {
            if ($request->title != "") {
                ...
                if ($request->file('document_file_4') != "") {
                    ...
                    $file = $request->file('document_file_4');
                    $document_photo = 'stu-' . md5($file->getClientOriginalName() . time()) . "." . $file->getClientOriginalExtension();
                    $file->move(public_path('uploads/student/timeline/'), $document_photo);
