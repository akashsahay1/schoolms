...
class TranslationServiceProvider extends ServiceProvider
{
    ...
    {
        // Wrap in try-catch to handle database connection issues during artisan commands
        try {
            Cache::forget('translations');
            if (Storage::exists('.app_installed') && Storage::get('.app_installed') && $this->hasValidDatabaseConnection()) {
            ...
            // Silently ignore database connection errors during boot
            // This allows artisan commands to run even without database
        }
    }
     ...
     * @return bool
     */
    protected function hasValidDatabaseConnection()
    {
        try {
