...
Route::group(['middleware' => ['XSS','subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        // Role Permission
        Route::get('assign-permission/{id}', ['as' => 'assign_permission', 'uses' => 'Admin\RolePermission\SmRolePermissionController@assignPermission']);
        Route::post('role-permission-store', ['as' => 'role_permission_store', 'uses' => 'Admin\RolePermission\SmRolePermissionController@rolePermissionStore']);
        ...
        //User Route (Legacy - kept for backward compatibility)
        Route::get('user', ['as' => 'user', 'uses' => 'UserController@index']);
        Route::get('user-create', ['as' => 'user_create', 'uses' => 'UserController@create']);

        // Administration - Admin Users Management (excludes Students, Parents, Teachers)
        Route::prefix('administration')->name('admin.')->group(function () {
            Route::get('users', ['as' => 'users.index', 'uses' => 'Admin\Administration\AdminUserController@index']);
            Route::get('users/create', ['as' => 'users.create', 'uses' => 'Admin\Administration\AdminUserController@create']);
            Route::post('users', ['as' => 'users.store', 'uses' => 'Admin\Administration\AdminUserController@store']);
            Route::get('users/{id}/edit', ['as' => 'users.edit', 'uses' => 'Admin\Administration\AdminUserController@edit']);
            Route::put('users/{id}', ['as' => 'users.update', 'uses' => 'Admin\Administration\AdminUserController@update']);
            Route::delete('users/{id}', ['as' => 'users.destroy', 'uses' => 'Admin\Administration\AdminUserController@destroy']);
            Route::post('users/search', ['as' => 'users.search', 'uses' => 'Admin\Administration\AdminUserController@search']);
            Route::post('users/toggle-status', ['as' => 'users.toggle-status', 'uses' => 'Admin\Administration\AdminUserController@toggleStatus']);
        });

        // Academic - Teachers Management
        Route::prefix('academic')->name('academic.')->group(function () {
            // Teachers Routes
            Route::get('teachers', ['as' => 'teachers.index', 'uses' => 'Admin\Academics\TeacherController@index']);
            Route::get('teachers/create', ['as' => 'teachers.create', 'uses' => 'Admin\Academics\TeacherController@create']);
            Route::post('teachers', ['as' => 'teachers.store', 'uses' => 'Admin\Academics\TeacherController@store']);
            Route::get('teachers/{id}', ['as' => 'teachers.show', 'uses' => 'Admin\Academics\TeacherController@show']);
            Route::get('teachers/{id}/edit', ['as' => 'teachers.edit', 'uses' => 'Admin\Academics\TeacherController@edit']);
            Route::put('teachers/{id}', ['as' => 'teachers.update', 'uses' => 'Admin\Academics\TeacherController@update']);
            Route::delete('teachers/{id}', ['as' => 'teachers.destroy', 'uses' => 'Admin\Academics\TeacherController@destroy']);
            Route::post('teachers/search', ['as' => 'teachers.search', 'uses' => 'Admin\Academics\TeacherController@search']);
            Route::post('teachers/toggle-status', ['as' => 'teachers.toggle-status', 'uses' => 'Admin\Academics\TeacherController@toggleStatus']);

            // Parents Routes (View-only - parents are created with students)
            Route::get('parents', ['as' => 'parents.index', 'uses' => 'Admin\Academics\ParentController@index']);
            Route::get('parents/{id}', ['as' => 'parents.show', 'uses' => 'Admin\Academics\ParentController@show']);
            Route::post('parents/search', ['as' => 'parents.search', 'uses' => 'Admin\Academics\ParentController@search']);
            Route::post('parents/toggle-status', ['as' => 'parents.toggle-status', 'uses' => 'Admin\Academics\ParentController@toggleStatus']);
            Route::get('parents/{id}/children', ['as' => 'parents.children', 'uses' => 'Admin\Academics\ParentController@getChildren']);
        });

        // Base group
        Route::get('base-group', ['as' => 'base_group', 'uses' => 'Admin\SystemSettings\SmBaseGroupController@index']);
        Route::post('base-group-store', ['as' => 'base_group_store', 'uses' => 'Admin\SystemSettings\SmBaseGroupController@store']);
        Route::get('base-group-edit/{id}', ['as' => 'base_group_edit', 'uses' => 'Admin\SystemSettings\SmBaseGroupController@edit']);
        Route::post('base-group-update', ['as' => 'base_group_update', 'uses' => 'Admin\SystemSettings\SmBaseGroupController@update']);
        Route::get('base-group-delete/{id}', ['as' => 'base_group_delete', 'uses' => 'Admin\SystemSettings\SmBaseGroupController@delete']);
        ...
        // income head routes
        Route::get('income-head', ['as' => 'income_head', 'uses' => 'Admin\Accounts\SmIncomeHeadController@index']);
        Route::post('income-head-store', ['as' => 'income_head_store', 'uses' => 'Admin\Accounts\SmIncomeHeadController@store']);
        Route::get('income-head-edit/{id}', ['as' => 'income_head_edit', 'uses' => 'Admin\Accounts\SmIncomeHeadController@edit']);
        Route::post('income-head-update', ['as' => 'income_head_update', 'uses' => 'Admin\Accounts\SmIncomeHeadController@update']);
        Route::get('income-head-delete/{id}', ['as' => 'income_head_delete', 'uses' => 'Admin\Accounts\SmIncomeHeadController@delete']);
        ...
        // Question Level
        Route::get('question-level', 'Admin\OnlineExam\SmQuestionLevelController@index')->name('question-level');
        Route::post('question-level', 'Admin\OnlineExam\SmQuestionLevelController@store')->name('question-level');
        Route::get('question-level/{id}', 'Admin\OnlineExam\SmQuestionLevelController@show')->name('question-level-edit');
        Route::put('question-level/{id}', 'Admin\OnlineExam\SmQuestionLevelController@update')->name('question-level-update');
        Route::delete('question-level/{id}', 'Admin\OnlineExam\SmQuestionLevelController@destroy')->name('question-level-delete');
        ...
        // Staff Hourly rate
        Route::get('hourly-rate', 'Admin\Hr\SmHourlyRateController@index')->name('hourly-rate');
        Route::post('hourly-rate', 'Admin\Hr\SmHourlyRateController@store')->name('hourly-rate');
        Route::get('hourly-rate', 'Admin\Hr\SmHourlyRateController@show')->name('hourly-rate');
        Route::put('hourly-rate', 'Admin\Hr\SmHourlyRateController@update')->name('hourly-rate');
        Route::delete('hourly-rate', 'Admin\Hr\SmHourlyRateController@destroy')->name('hourly-rate');
        ...
        Route::get('search-issued-book', 'Admin\Library\SmBookController@allIssuedBook');
