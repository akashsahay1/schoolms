...
//Install for Demo - InstallController not found, commenting out
...
Route::group(['middleware' => ['XSS']], function () {
    ...
    // InstallController not found - commenting out
    ...
    Route::post('payment_gateway_success_callback/{method}', 'PaymentGatewayCallbackController@successCallBack'); // For PayU POST callback
    Route::post('payment_gateway_cancel_callback/{method}', 'PaymentGatewayCallbackController@cancelCallback'); // For PayU POST callback
    Route::post('makeFeesPayment', 'GatewayPaymentController@makeFeesPayment')->name('makeFeesPayment');
    Route::get('payu/redirect', 'PayURedirectController@redirect')->name('payu.redirect');
    ...
    Route::get('moduleAddOnsEnable/{name}', 'Admin\SystemSettings\SmAddOnsController@moduleAddOnsEnable')->name('moduleAddOnsEnable');
...
Route::get('fees/paypal/status', 'SmCollectFeesByPaymentGateway@getPaymentStatus')->name('paypal.status');
Route::get('fees/paypal/cancel', 'SmCollectFeesByPaymentGateway@paypalCancel')->name('paypal.cancel');
